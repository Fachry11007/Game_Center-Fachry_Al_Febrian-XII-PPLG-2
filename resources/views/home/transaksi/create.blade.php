...
@section('page-subtitle', 'Tambah data transaksi baru')
@section('breadcrumb')
@endsection
@section('content')
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="id_akun" id="id_akun" value="{{ old('id_akun') }}" required>
                  @error('id_akun')
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="item" id="item" value="{{ old('item') }}" required>
                  @error('item')
                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                  @enderror
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" name="jumlah_diamond" id="jumlah_diamond" value="{{ old('jumlah_diamond') }}" required>
